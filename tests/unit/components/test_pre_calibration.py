...
from components.pre_calibration import PreCalibrationComponent
...
class TestPreCalibrationComponent:
    ...
    @patch('components.pre_calibration.BaseComponent.execute')
    ...
    @patch('components.pre_calibration.BaseComponent.execute', side_effect=Exception("Base component error"))
    ...
    def test_result_keys_consistency(self):
        ...
        for context in test_contexts:
            with patch.object(component, 'log_info'):
                with patch('components.pre_calibration.BaseComponent.execute'):
                    result = component.execute(context)
