...
import logging
import sys
from frameworks.service_pipeline import ServiceRegistry, ServiceEntrypoint
from frameworks.service_pipeline.orchestration.config_validator import validate_config
...
def main():
    ...
    try:
        ...
        if not validate_config(
            'frameworks/service_pipeline/resources/services.json',
            'frameworks/service_pipeline/resources/interceptors.json'
        ):
        ...
        registry = ServiceRegistry(
            config_path='frameworks/service_pipeline/resources/services.json'
        )
        ...
        service = ServiceEntrypoint(
            registry=registry,
            interceptor_config_path='frameworks/service_pipeline/resources/interceptors.json'
        )
