...
from components.simulation import SimulationComponent
...
class TestSimulationComponent:
    ...
    @patch('components.simulation.BaseComponent.execute')
    ...
    @patch('components.simulation.BaseComponent.execute', side_effect=Exception("Base component error"))
    ...
    def test_result_keys_consistency(self):
        ...
        for context in test_contexts:
            with patch.object(component, 'log_info'):
                with patch('components.simulation.BaseComponent.execute'):
                    result = component.execute(context)
