...
from frameworks.service_pipeline.implementation.interceptors.validation import (
...
class TestValidationInterceptor:
    ...
    def test_after_invalid_response_strict(self):
        ...
        with pytest.raises(ValidationError, match="Response validation failed"):
            interceptor.after(context, result)  # type: ignore[arg-type]
    ...
    def test_after_no_validation(self):
        ...
        returned_result = interceptor.after(context, result)  # type: ignore[arg-type]
